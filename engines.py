...
class PlannerEngine:
    ...
    def _decide(self, flags: Set[str], scores: Dict[str, int]) -> Tuple[str, str]:
        ...
        # Fast memory-care override if present in the JSON
    ...
    def _match(self, rule_name: str, meta: Dict[str, Any], ctx: Dict[str, Any],
        ...
        # A few explicit rule handlers (align with your JSON names)
        if rule_name == "dependence_flag_logic":
            # If JSON includes the list of flags to count, use it; else count any dependence-like flags
