...
# ---- Read-only totals helper for PFMA & Breakdown (no writes) ----
...
def compute_totals(state):
    ...
    va_A = _to_int_safe(_get_first(s,"va_A","a_va_monthly"))
    va_B = _to_int_safe(_get_first(s,"va_B","b_va_monthly"))
    ...
    return {
        ...
        "years": months_runway//12, "rem": months_runway%12,
    }
