...
# ---------- Engines ----------
try:
    from engines import PlannerEngine, CalculatorEngine, CalcInputs  # CalcInputs may or may not exist
except Exception:
...
# ---------- Breakdown ----------
    ...
    # Other monthly costs (if you later enable those drawers)
    ...
    # Assets (sum common + detailed if you captured them)
